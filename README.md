<h2 align="center">:rocket: Hi, I'm Hernán Chamorro :rocket:</h2><p>
...
In addition to the latter, I decided to start my studies for <i>Fullstack Python</i> at <b> PoloTic Misiones </b>. <br />
  I have extra courses on <i>Coursera, Cisco Networking Academy, Udemy, and more</i>, to improve my technical profile (see LinkedIn) and be able to calm the insatiable desire to always learn a little more about this world.<br />
I am developing projects in <i>React - React / Redux - Express JS - Sequelize - Testing</i>. This is the space where you can check my progress.<br /><br />
